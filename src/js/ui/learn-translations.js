...
export const TR = {
  'major-scale': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-3, 3-4 …)', description: 'Clássico de método: sobe a escala em pares sobrepostos de notas adjacentes (1-2, 2-3, 3-4, …). Colcheias o tempo todo, terminando na tônica.' },
        { title: 'Pares descendentes (8-7, 7-6, 6-5 …)', description: 'O mesmo padrão na volta — pares sobrepostos de notas adjacentes do topo até a tônica.' },
        { title: 'Tríades ascendentes (1-2-3, 2-3-4 …)', description: 'Grupos de três notas sobrepostos — padrão clássico de método. Cada grupo cabe em um tempo, como tercinas de colcheia.' },
        { title: 'Tríades descendentes (8-7-6, 7-6-5 …)', description: 'O mesmo padrão de três notas, agora descendo da tônica de cima.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-3, 3-4 …)', description: 'Clásico de método: sube la escala en pares solapados de notas adyacentes (1-2, 2-3, 3-4, …). Corcheas todo el tramo, terminando en la tónica.' },
        { title: 'Pares descendentes (8-7, 7-6, 6-5 …)', description: 'El mismo patrón en la vuelta — pares solapados de notas adyacentes desde lo alto hasta la tónica.' },
        { title: 'Tríadas ascendentes (1-2-3, 2-3-4 …)', description: 'Grupos de tres notas solapados — patrón clásico de método. Cada grupo cabe en un pulso como tresillos de corcheas.' },
        { title: 'Tríadas descendentes (8-7-6, 7-6-5 …)', description: 'El mismo patrón de tres notas, esta vez bajando desde la tónica superior.' },
      ],
    },
  },
  'natural-minor': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-3 …)', description: 'Pares sobrepostos de notas adjacentes subindo Lá menor natural — a 3ª, 6ª e 7ª abaixadas ficam evidentes nesse padrão.' },
        { title: 'Pares descendentes (8-7, 7-6 …)', description: 'O mesmo padrão de pares descendo por Lá menor natural.' },
        { title: 'Tríades ascendentes (1-2-3, 2-3-4 …)', description: 'Grupos de três notas sobrepostos em Lá menor — tercinas de colcheia, um grupo por tempo.' },
        { title: 'Tríades descendentes (8-7-6, 7-6-5 …)', description: 'Grupos de três descendo — ótimo pra internalizar os movimentos ♭6 → 5 e ♭3 → 2 em Lá menor.' },
      ],
    },
    es: {
      title: 'Escala Menor Natural',
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-3 …)', description: 'Pares solapados de notas adyacentes subiendo La menor natural — la 3ª, 6ª y 7ª rebajadas se notan claramente en este patrón.' },
        { title: 'Pares descendentes (8-7, 7-6 …)', description: 'El mismo patrón de pares bajando por La menor natural.' },
        { title: 'Tríadas ascendentes (1-2-3, 2-3-4 …)', description: 'Grupos de tres notas solapados en La menor — tresillos de corcheas, un grupo por pulso.' },
        { title: 'Tríadas descendentes (8-7-6, 7-6-5 …)', description: 'Grupos de tres bajando — útil para interiorizar los movimientos ♭6 → 5 y ♭3 → 2 en La menor.' },
      ],
    },
  },
  'pentatonic-minor': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-3 …)', description: 'Pares sobrepostos de notas adjacentes da pentatônica — cada intervalo é uma terça menor ou um tom, nunca um semitom. Ótimo pra aquecimento.' },
        { title: 'Pares descendentes (8-7, 7-6 …)', description: 'Pares descendendo — abertura típica de uma frase de blues.' },
        { title: 'Tríades ascendentes (1-2-3, 2-3-4 …)', description: 'Grupos de três notas subindo a pentatônica — útil pra guitarristas treinando shapes em posição.' },
        { title: 'Tríades descendentes (8-7-6, 7-6-5 …)', description: 'Grupos de três descendendo — soa como um lick clássico de rock por si só.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-3 …)', description: 'Pares solapados de notas adyacentes de la pentatónica — cada intervalo es una tercera menor o un tono, nunca un semitono. Ideal para calentar.' },
        { title: 'Pares descendentes (8-7, 7-6 …)', description: 'Pares solapados descendentes — apertura típica de una frase de blues.' },
        { title: 'Tríadas ascendentes (1-2-3, 2-3-4 …)', description: 'Grupos de tres notas subiendo por la pentatónica — útil para guitarristas trabajando posiciones.' },
        { title: 'Tríadas descendentes (8-7-6, 7-6-5 …)', description: 'Grupos de tres descendentes — suena como un lick clásico de rock por sí solo.' },
      ],
    },
  },
  'pentatonic-major': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-3 …)', description: 'Pares sobrepostos de notas adjacentes subindo a pentatônica de Dó maior.' },
        { title: 'Pares descendentes (8-7, 7-6 …)', description: 'O mesmo padrão de pares descendendo.' },
        { title: 'Tríades ascendentes (1-2-3, 2-3-4 …)', description: 'Grupos de três notas subindo a pentatônica maior — padrão fundamental em licks de country e gospel.' },
        { title: 'Tríades descendentes (8-7-6, 7-6-5 …)', description: 'Grupos de três descendendo — típico de ornamentos melódicos folk e brasileiros.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-3 …)', description: 'Pares solapados de notas adyacentes subiendo la pentatónica de Do mayor.' },
        { title: 'Pares descendentes (8-7, 7-6 …)', description: 'El mismo patrón de pares bajando.' },
        { title: 'Tríadas ascendentes (1-2-3, 2-3-4 …)', description: 'Grupos de tres notas subiendo la pentatónica mayor — patrón fundamental en licks de country y gospel.' },
        { title: 'Tríadas descendentes (8-7-6, 7-6-5 …)', description: 'Grupos de tres descendentes — típico de adornos melódicos folk y brasileños.' },
      ],
    },
  },
  'blues-scale': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-♭3, ♭3-4 …)', description: 'Pares sobrepostos pela escala de blues — a aproximação por semitom ao 5 (♭5 → 5) cai dentro da sequência, treinando a blue note em contexto.' },
        { title: 'Pares descendentes (8-♭7, ♭7-5 …)', description: 'Pares sobrepostos descendendo — o movimento 5 → ♭5 na volta é uma virada clássica do blues.' },
        { title: 'Tríades ascendentes (1-♭3-4, ♭3-4-♭5 …)', description: 'Grupos de três notas subindo a escala de blues — cada outro grupo inclui a blue note (♭5), reciclando a tensão.' },
        { title: 'Tríades descendentes (8-♭7-5, ♭7-5-♭5 …)', description: 'Grupos de três descendendo — puxa a blue note por cada transição.' },
      ],
    },
    es: {
      title: 'Escala de Blues',
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-♭3, ♭3-4 …)', description: 'Pares solapados por la escala de blues — la aproximación por semitono al 5 (♭5 → 5) cae dentro de la secuencia, entrenando la blue note en contexto.' },
        { title: 'Pares descendentes (8-♭7, ♭7-5 …)', description: 'Pares solapados bajando — el movimiento 5 → ♭5 en la vuelta es una vuelta clásica del blues.' },
        { title: 'Tríadas ascendentes (1-♭3-4, ♭3-4-♭5 …)', description: 'Grupos de tres notas subiendo la escala de blues — cada otro grupo incluye la blue note (♭5), reciclando la tensión.' },
        { title: 'Tríadas descendentes (8-♭7-5, ♭7-5-♭5 …)', description: 'Grupos de tres bajando — tira la blue note por cada transición.' },
      ],
    },
  },
  'harmonic-minor': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-♭3 …)', description: 'Pares sobrepostos subindo a menor harmônica. A 2ª aumentada entre ♭6 e 7 (F → G#) cai dentro de um par — treine até soar natural.' },
        { title: 'Pares descendentes (8-7, 7-♭6 …)', description: 'Pares descendendo — o salto 7 → ♭6 (G# → F) é a mesma 2ª aumentada, agora caindo na descida.' },
        { title: 'Tríades ascendentes (1-2-♭3, 2-♭3-4 …)', description: 'Grupos de três subindo. O grupo 5 (♭6-7-8) atravessa a 2ª aumentada como tercina — o dedilhado mais exigente da escala.' },
        { title: 'Tríades descendentes (8-7-♭6, 7-♭6-5 …)', description: 'Grupos de três descendendo — a 2ª aumentada aparece nos dois primeiros grupos (8-7-♭6 e 7-♭6-5).' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Pares ascendentes (1-2, 2-♭3 …)', description: 'Pares solapados subiendo la menor armónica. La 2ª aumentada entre ♭6 y 7 (F → G#) cae dentro de un par — entrena hasta que suene natural.' },
        { title: 'Pares descendentes (8-7, 7-♭6 …)', description: 'Pares bajando — el salto 7 → ♭6 (G# → F) es la misma 2ª aumentada, ahora cayendo en la bajada.' },
        { title: 'Tríadas ascendentes (1-2-♭3, 2-♭3-4 …)', description: 'Grupos de tres subiendo. El grupo 5 (♭6-7-8) atraviesa la 2ª aumentada como tresillo — el digitado más exigente de la escala.' },
        { title: 'Tríadas descendentes (8-7-♭6, 7-♭6-5 …)', description: 'Grupos de tres bajando — la 2ª aumentada aparece en los dos primeros grupos (8-7-♭6 y 7-♭6-5).' },
      ],
    },
  },
  'greek-modes': {
  ...
  'walking-bass-triplets': {
    pt: {
      title: 'Boogie, Tercinas & Shuffle',
      summary: 'Padrões sobre notas do acorde, fills em tercina e a colcheia shuffled — três idiomas que definem o swing e o blues no baixo.',
      tag: 'Baixo · Walking',
      steps: [
        { title: 'Padrões, tercinas e a colcheia shuffled', text: `Três idiomas em um módulo. O <strong>boogie</strong> se apoia em um padrão repetido sobre notas do acorde (1-3-5-6-♭7-6-5-3) em vez de um walking improvisado. Os <strong>fills de tercina</strong> espremem três notas em um único tempo — normalmente no tempo 4, impulsionando a linha para o próximo compasso. A <strong>colcheia shuffled</strong> transforma "1-e-2-e" em longa-curta, longa-curta, dividindo cada tempo em tercina-de-semínima + tercina-de-colcheia (a longa cai no tempo; a curta é o "e" atrasado).` },
        ...
        { title: 'Fill em tercina no tempo 4', description: 'Semínimas nos tempos 1-3, depois três tercinas de colcheia no tempo 4 varrem para o próximo compasso.' },
        { title: 'Suingue da colcheia shuffled', description: 'Cada tempo é uma tercina-de-semínima + tercina-de-colcheia — o "longa-curta" que conduz toda linha de baixo shuffled. Oito notas por compasso.' },
      ],
    },
    es: {
      title: 'Boogie, Tresillos & Shuffle',
      summary: 'Patrones sobre notas del acorde, fills en tresillo y la corchea shuffled — tres idiomas que definen el swing y el blues en el bajo.',
      tag: 'Bajo · Walking',
      steps: [
        { title: 'Patrones, tresillos y la corchea shuffled', text: `Tres idiomas en un módulo. El <strong>boogie</strong> se apoya en un patrón repetido sobre notas del acorde (1-3-5-6-♭7-6-5-3) en vez de un walking improvisado. Los <strong>fills de tresillo</strong> comprimen tres notas en un solo pulso — normalmente en el pulso 4, impulsando la línea hacia el próximo compás. La <strong>corchea shuffled</strong> convierte "1-y-2-y" en larga-corta, larga-corta, dividiendo cada pulso en tresillo-de-negra + tresillo-de-corchea (la larga cae en el pulso; la corta es la "y" desplazada).` },
        ...
        { title: 'Fill en tresillo en el pulso 4', description: 'Negras en los pulsos 1-3, luego tres corcheas en tresillo en el pulso 4 barren hacia el próximo compás.' },
        { title: 'Swing de la corchea shuffled', description: 'Cada pulso es una negra-en-tresillo + corchea-en-tresillo — el "larga-corta" que mueve toda línea de bajo shuffled. Ocho notas por compás.' },
      ],
    },
  },
  'walking-bass-blues': {
  ...
  'counterpoint-species-1': {
    pt: {
      title: 'Contraponto I — Nota contra nota',
      summary: 'Contraponto de primeira espécie: uma nota por tempo em cada voz, só intervalos consonantes, movimento contrário preferido.',
      tag: 'Contraponto · 1ª espécie',
      steps: [
        { title: 'As regras num parágrafo', text: `O contraponto de primeira espécie casa um <em>cantus firmus</em> (uma melodia dada, lenta) com uma segunda voz no mesmo andamento — uma nota contra uma. Os únicos intervalos verticais permitidos são <strong>consonâncias perfeitas</strong> (uníssono, 5ª, oitava) e <strong>imperfeitas</strong> (3ª, 6ª). Evite 5ªs e oitavas paralelas, e prefira <strong>movimento contrário</strong>. O primeiro e o último compasso terminam na tônica com consonância perfeita.` },
        { title: 'Cantus firmus em Dó maior', description: 'Um cantus firmus simples de 8 compassos na voz inferior. Cante sozinho primeiro — cada nota está a um tom ou a uma terça da vizinha.' },
        { title: 'Contraponto acima do cantus', description: 'Linha de primeira espécie sobre o mesmo cantus. Todo intervalo vertical é 3ª, 5ª, 6ª ou oitava; movimento contrário aparece nos compassos 2-3 e 6-7.' },
        { title: 'Contraponto abaixo do cantus', description: 'Mesmo cantus em cima; a voz inferior faz o contraponto. Repare como a voz de baixo espelha a direção da de cima na cadência.' },
        { title: 'Voz superior sozinha', description: 'Apenas a linha de contraponto superior do segundo exercício — útil pra internalizar antes de juntar as vozes.' },
      ],
    },
    es: {
      title: 'Contrapunto I — Nota contra nota',
      summary: 'Contrapunto de primera especie: una nota por pulso en cada voz, solo intervalos consonantes, movimiento contrario preferido.',
      tag: 'Contrapunto · 1ª especie',
      steps: [
        { title: 'Las reglas en un párrafo', text: `El contrapunto de primera especie empareja un <em>cantus firmus</em> (una melodía dada, lenta) con una segunda voz al mismo ritmo — una nota contra una. Los únicos intervalos verticales permitidos son <strong>consonancias perfectas</strong> (unísono, 5ª, octava) y <strong>imperfectas</strong> (3ª, 6ª). Evita 5ªs y octavas paralelas, y prefiere <strong>movimiento contrario</strong>. El primer y último compás aterrizan en la tónica con consonancia perfecta.` },
        { title: 'Cantus firmus en Do mayor', description: 'Un cantus firmus simple de 8 compases en la voz inferior. Cántalo solo primero — cada nota está a un tono o una tercera de la vecina.' },
        { title: 'Contrapunto sobre el cantus', description: 'Línea de primera especie sobre el mismo cantus. Todo intervalo vertical es 3ª, 5ª, 6ª u octava; el movimiento contrario aparece en los compases 2-3 y 6-7.' },
        { title: 'Contrapunto bajo el cantus', description: 'Mismo cantus arriba; la voz inferior hace el contrapunto. Fíjate cómo la voz de abajo refleja la dirección de la de arriba en la cadencia.' },
        { title: 'Voz superior sola', description: 'Solo la línea de contrapunto superior del segundo ejercicio — útil para interiorizarla antes de juntar las voces.' },
      ],
    },
  },
  'counterpoint-passing-tones': {
    pt: {
      title: 'Contraponto II — Notas de passagem',
      summary: 'A segunda espécie adiciona uma nota não-acordal entre consonâncias. Duas notas por tempo na voz contra.',
      tag: 'Contraponto · 2ª espécie',
      steps: [
        { title: 'Dissonância, mas só de passagem', text: `O contraponto de segunda espécie acelera a voz contra: <strong>duas mínimas para cada semibreve</strong> do cantus firmus. A primeira mínima precisa ser consonante com o cantus; a segunda pode ser uma <strong>nota de passagem</strong> (dissonância aproximada e deixada por grau) no tempo fraco. É aqui que a dissonância entra no contraponto ocidental — controlada, breve, sempre entre duas consonâncias.` },
        { title: 'Voz contra com notas de passagem (ascendente)', description: 'Cada compasso do cantus recebe duas notas da voz contra — a segunda costuma ser uma nota de passagem suavizando o salto.' },
        { title: 'Voz contra com notas de passagem (descendente)', description: 'Agora a voz superior começa no alto e desce por notas de passagem até voltar à tônica em uníssono.' },
        { title: 'Voz contra sozinha', description: 'A linha superior do exemplo ascendente — cante pra sentir o alisamento das notas de passagem.' },
        { title: 'Cantus firmus sozinho', description: 'A voz inferior (mais lenta) dos exemplos anteriores — semibreves sustentadas delineando a harmonia por baixo das notas de passagem.' },
      ],
    },
    es: {
      title: 'Contrapunto II — Notas de paso',
      summary: 'La segunda especie añade una nota no-acordal entre consonancias. Dos notas por pulso en la voz contra.',
      tag: 'Contrapunto · 2ª especie',
      steps: [
        { title: 'Disonancia, pero solo de paso', text: `El contrapunto de segunda especie acelera la voz contra: <strong>dos blancas por cada redonda</strong> del cantus firmus. La primera blanca debe ser consonante con el cantus; la segunda puede ser una <strong>nota de paso</strong> (disonancia aproximada y dejada por grado) en el tiempo débil. Aquí entra la disonancia en el contrapunto occidental — controlada, breve, siempre entre dos consonancias.` },
        { title: 'Voz contra con notas de paso (ascendente)', description: 'Cada compás del cantus recibe dos notas de la voz contra — la segunda suele ser una nota de paso suavizando el salto.' },
        { title: 'Voz contra con notas de paso (descendente)', description: 'Ahora la voz superior empieza arriba y desciende por notas de paso hasta volver al unísono con la tónica.' },
        { title: 'Voz contra sola', description: 'La línea superior del ejemplo ascendente — cántala para sentir cómo las notas de paso suavizan la línea.' },
        { title: 'Cantus firmus solo', description: 'La voz inferior (más lenta) de los ejemplos previos — redondas sostenidas que delinean la armonía bajo las notas de paso.' },
      ],
    },
  },
  'counterpoint-suspensions': {
    pt: {
      title: 'Contraponto IV — Suspensões',
      summary: 'Uma nota do compasso anterior é sustentada sobre uma nova harmonia — gerando tensão — e resolvida descendo de grau.',
      tag: 'Contraponto · 4ª espécie',
      steps: [
        { title: '4-3, 7-6, 9-8 — preparação, suspensão, resolução', text: `Uma suspensão tem três etapas: <strong>preparação</strong> (consonância), <strong>suspensão</strong> (a mesma nota sustentada no compasso seguinte, agora dissonante) e <strong>resolução</strong> (a nota suspensa desce de grau até uma consonância). Os padrões mais comuns recebem nome pelos intervalos: <strong>4-3</strong> resolve uma 4ª descendo pra 3ª, <strong>7-6</strong> resolve uma 7ª pra 6ª, <strong>9-8</strong> resolve uma 9ª pra oitava. As suspensões são o jeito que renascentistas e barrocos construíam peso emocional sem mudar o ritmo.` },
        { title: 'Cadeia de suspensões 4-3', description: 'Cada compasso prepara, sustenta e resolve uma suspensão 4-3 sobre a voz inferior. A dissonância é breve mas inconfundível.' },
        { title: 'Cadeia de suspensões 7-6', description: 'Série de suspensões 7-6 — o tipo mais cantável, às vezes chamado padrão "suspiro".' },
        { title: 'Voz superior sozinha', description: 'A voz superior suspensa da cadeia 7-6 — cada par "se inclina" descendo de grau.' },
        { title: 'Voz inferior sozinha', description: 'O baixo da mesma cadeia — semibreves lentas que ancoram a harmonia e tornam as suspensões audíveis acima.' },
      ],
    },
    es: {
      title: 'Contrapunto IV — Suspensiones',
      summary: 'Una nota del compás anterior se sostiene sobre una nueva armonía — creando tensión — y resuelve bajando un grado.',
      tag: 'Contrapunto · 4ª especie',
      steps: [
        { title: '4-3, 7-6, 9-8 — preparación, suspensión, resolución', text: `Una suspensión tiene tres pasos: <strong>preparación</strong> (consonancia), <strong>suspensión</strong> (la misma nota sostenida en el compás siguiente, ahora disonante) y <strong>resolución</strong> (la nota suspendida baja un grado a una consonancia). Los patrones comunes se nombran por intervalos: <strong>4-3</strong> resuelve una 4ª bajando a 3ª, <strong>7-6</strong> resuelve una 7ª a 6ª, <strong>9-8</strong> resuelve una 9ª a octava. Las suspensiones son cómo renacentistas y barrocos construían peso emocional sin alterar el ritmo.` },
        { title: 'Cadena de suspensiones 4-3', description: 'Cada compás prepara, sostiene y resuelve una suspensión 4-3 sobre la voz inferior. La disonancia es breve pero inconfundible.' },
        { title: 'Cadena de suspensiones 7-6', description: 'Serie de suspensiones 7-6 — el tipo más cantable, a veces llamado patrón "suspiro".' },
        { title: 'Voz superior sola', description: 'La voz superior suspendida de la cadena 7-6 — cada par "se inclina" bajando un grado.' },
        { title: 'Voz inferior sola', description: 'El bajo de la misma cadena — redondas lentas que anclan la armonía y hacen audibles las suspensiones arriba.' },
      ],
    },
  },
  'counterpoint-imitation': {
    pt: {
      title: 'Imitação e Cânon',
      summary: 'A voz 2 entra depois da voz 1 com o mesmo desenho melódico — base de fugas, rondós e invenções.',
      tag: 'Contraponto · Imitação',
      steps: [
        { title: 'Mesmas notas, tempo diferente', text: `<strong>Imitação</strong> é o truque contrapontístico mais simples: a voz 2 entra alguns tempos depois da voz 1 com o mesmo desenho melódico. Quando a imitação é exata — todo intervalo, todo ritmo —, vira <strong>cânon</strong>. O intervalo e o atraso da entrada dão o sabor do cânon: <strong>oitava</strong> (mais comum), <strong>5ª</strong> (Pachelbel), <strong>uníssono</strong> (rondós como Frère Jacques).` },
        { title: 'Cânon na oitava', description: 'Ambas as vozes têm o mesmo desenho, mas a voz 2 (mais grave) atrasa dois tempos — em cada coluna você ouve voz 1 no "passo n" contra voz 2 no "passo n−2".' },
        { title: 'Voz líder sozinha', description: 'Só a frase líder — cante ou toque sozinho pra firmar o desenho antes de empilhar.' },
        { title: 'Voz seguidora sozinha', description: 'A linha seguidora — mesmo desenho da líder, uma oitava abaixo.' },
      ],
    },
    es: {
      title: 'Imitación y Cánon',
      summary: 'La voz 2 entra después de la voz 1 con la misma forma melódica — la base de fugas, rondós e invenciones.',
      tag: 'Contrapunto · Imitación',
      steps: [
        { title: 'Mismas notas, distinto tiempo', text: `La <strong>imitación</strong> es el truco contrapuntístico más simple: la voz 2 entra unos pulsos después de la voz 1 con el mismo perfil melódico. Cuando la imitación continúa exactamente — cada intervalo, cada ritmo — se convierte en <strong>cánon</strong>. El intervalo y el desfase de la entrada definen el sabor del cánon: <strong>octava</strong> (lo más común), <strong>5ª</strong> (Pachelbel), <strong>unísono</strong> (rondós como Frère Jacques).` },
        { title: 'Cánon a la octava', description: 'Ambas voces tocan la misma forma, pero la voz 2 (grave) llega dos pulsos tarde — en cada columna oyes la voz 1 en el "paso n" contra la voz 2 en el "paso n−2".' },
        { title: 'Voz líder sola', description: 'Solo la frase líder — cántala o tócala sola para fijar la forma antes de apilarla.' },
        { title: 'Voz seguidora sola', description: 'La línea seguidora — misma forma que la líder, una octava más grave.' },
      ],
    },
  },
  'counterpoint-free': {
    pt: {
      title: 'Contraponto livre',
      summary: 'Misturando espécies — notas de passagem, suspensões e imitação numa peça curta.',
      tag: 'Contraponto · Livre',
      steps: [
        { title: 'Juntando as ferramentas', text: `O contraponto livre (ou de quinta espécie) abandona as restrições por espécie e combina tudo: <strong>notas de passagem</strong> para movimento, <strong>suspensões</strong> para peso emocional, <strong>entradas imitativas</strong> breves para unidade, tudo sobre um cantus firmus ou progressão lenta. As invenções a duas vozes de Bach são o exemplo canônico — curtas, didáticas, densas.` },
        { title: 'Abertura estilo invenção', description: 'Oito compassos combinando primeira espécie nas fundações, uma nota de passagem no compasso 3 e uma suspensão 7-6 no compasso 6.' },
        { title: 'Voz superior sozinha', description: 'A linha superior do exemplo — frase que você pode reconhecer de Bach.' },
        { title: 'Voz inferior sozinha', description: 'A voz inferior (estilo cantus) do mesmo exemplo — mais lenta, ancorando a harmonia.' },
      ],
    },
    es: {
      title: 'Contrapunto libre',
      summary: 'Mezclando especies — notas de paso, suspensiones e imitación en una pieza breve.',
      tag: 'Contrapunto · Libre',
      steps: [
        { title: 'Combinando las herramientas', text: `El contrapunto libre (o de quinta especie) deja atrás las restricciones por especie y lo combina todo: <strong>notas de paso</strong> para el movimiento, <strong>suspensiones</strong> para el peso emocional, <strong>entradas imitativas</strong> breves para la unidad, sobre un cantus firmus o progresión lenta. Las invenciones a dos voces de Bach son el ejemplo canónico — cortas, didácticas, densas.` },
        { title: 'Apertura tipo invención', description: 'Ocho compases combinando primera especie en la base, una nota de paso en el compás 3 y una suspensión 7-6 en el compás 6.' },
        { title: 'Voz superior sola', description: 'La línea superior del ejemplo — frase que quizá reconozcas de Bach.' },
        { title: 'Voz inferior sola', description: 'La voz inferior (tipo cantus) del mismo ejemplo — más lenta, anclando la armonía.' },
      ],
    },
  },
};
