  ...
  'natural-minor': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Linha ascendente', description: 'Pequeno trecho subindo pela menor natural — bem mais sombrio que a maior.' },
      ],
    },
    es: {
      title: 'Escala Menor Natural',
      ...
      steps: [
        ...
        { title: 'Línea ascendente', description: 'Pequeño fragmento subiendo por la menor natural — bastante más sombrío que la mayor.' },
      ],
    },
  },
  'pentatonic-minor': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Lick bluesy', description: 'Frase clássica de blues construída só sobre a pentatônica menor.' },
    ...
    es: {
      ...
      steps: [
        ...
        { title: 'Lick bluesy', description: 'Frase clásica de blues construida solo con la pentatónica menor.' },
  ...
  'pentatonic-major': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Lick country', description: 'Lick típico de country construído sobre a pentatônica maior.' },
    ...
    es: {
      ...
      steps: [
        ...
        { title: 'Lick country', description: 'Lick típico de country construido sobre la pentatónica mayor.' },
  ...
  'greek-modes': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Melodia em dórico', description: 'Pequena frase em D dórico.' },
    ...
    es: {
      ...
      steps: [
        ...
        { title: 'Melodía en dórico', description: 'Pequeña frase en D dórico.' },
  ...
  'minor-triad': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Tríade com notas vizinhas', description: 'A tríade com bordaduras (notas adjacentes) ornamentando.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Tríada con vecinas', description: 'La tríada con bordaduras (notas adyacentes) ornamentando.' },
      ],
    },
  },
  'tetrads': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Linha bebop com 7ª', description: 'Frase à moda bebop usando as notas do acorde de 7ª.' },
    ...
    es: {
      ...
      steps: [
        ...
        { title: 'Línea bebop con 7ª', description: 'Frase tipo bebop usando las notas del acorde de 7ª.' },
  ...
  'prog-i-v-vi-iv': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Riff sobre o loop', description: 'Riff melódico curto que se encaixa em qualquer ciclo I–V–vi–IV.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Riff sobre el loop', description: 'Riff melódico corto que encaja en cualquier ciclo I–V–vi–IV.' },
      ],
    },
  },
  'prog-50s': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Baixo caminhando entre os acordes', description: 'Linha de baixo conectando os acordes em movimento por passos.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Bajo caminando entre los acordes', description: 'Línea de bajo conectando los acordes con movimiento por grados.' },
      ],
    },
  },
  'prog-12-bar-blues': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Walking bass de blues', description: 'Linha de baixo "andando" sob a progressão do blues.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Walking bass de blues', description: 'Línea de bajo "caminando" bajo la progresión del blues.' },
      ],
    },
  },
  'prog-ii-v-i': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Melodia sobre ii–V–I', description: 'Linha melódica destacando os acordes da cadência.' },
        { title: 'ii–V–I em todas as tonalidades', description: 'Pequeno exercício de cadência ii–V–I modulando.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Melodía sobre ii–V–I', description: 'Línea melódica destacando los acordes de la cadencia.' },
        { title: 'ii–V–I en todas las tonalidades', description: 'Pequeño ejercicio de cadencia ii–V–I modulando.' },
      ],
    },
  },
  'prog-andalusian': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Linha de baixo descendente', description: 'A linha de baixo isolada — sinta o caráter inexorável da descida.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Línea de bajo descendente', description: 'La línea de bajo aislada — siente el carácter inexorable del descenso.' },
      ],
    },
  },
  'prog-pachelbel': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Linha de baixo descendente', description: 'O baixo isolado, com sua descida característica.' },
      ],
    },
    es: {
      title: 'Pachelbel (I–V–vi–iii–IV–I–IV–V)',
      ...
      steps: [
        ...
        { title: 'Línea de bajo descendente', description: 'El bajo aislado, con su descenso característico.' },
      ],
    },
  },
  'prog-vi-iv-i-v': {
  ...
  'prog-circle-fifths': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Walking bass no ciclo', description: 'Linha de baixo caminhando sobre as 5as descendentes.' },
      ],
    },
    es: {
      ...
      steps: [
        ...
        { title: 'Walking bass en el ciclo', description: 'Línea de bajo caminando sobre las 5as descendentes.' },
      ],
    },
  },
  ...
  'walking-bass': {
    pt: {
      ...
      steps: [
        ...
        { title: 'Adicione a 3ª', description: 'Use também a 3ª — agora tem 3 notas-pilares por acorde.' },
      ],
    },
    es: {
      title: 'Walking Bass — Fundamentos',
      ...
      steps: [
        ...
        { title: 'Añade la 3ª', description: 'Usa también la 3ª — ahora hay 3 notas-pilares por acorde.' },
      ],
    },
  },
  'walking-diatonic': {
